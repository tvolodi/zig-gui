//! 04 — Layout engine — src/04/types.zig  (reconciled with module 03)
//!
...
//!
//! (AGENT AMENDMENT 2026-06-14: SR-03 — moved canonical impl from docs/specs/04.types.zig
//!  to src/04/types.zig per INV-5.7; src/ is now the sole compilation source.)
