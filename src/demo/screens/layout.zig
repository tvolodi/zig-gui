...
pub fn build(
    ...
    const box_a = NodeDesc{ .tag = "Card", .classes = "p-4", .attrs = &ba_attrs };
    const box_b = NodeDesc{ .tag = "Card", .classes = "p-4", .attrs = &bb_attrs };
    const box_c = NodeDesc{ .tag = "Card", .classes = "p-4", .attrs = &bc_attrs };
    const box_d = NodeDesc{ .tag = "Card", .classes = "p-4", .attrs = &bd_attrs };
    const box_e = NodeDesc{ .tag = "Card", .classes = "p-4", .attrs = &be_attrs };
    ...
    const gi1 = NodeDesc{ .tag = "Card", .classes = "p-2",        .attrs = &gi1_attrs };
    const gi2 = NodeDesc{ .tag = "Card", .classes = "flex-1 p-2", .attrs = &gi2_attrs };
    const gi3 = NodeDesc{ .tag = "Card", .classes = "p-2",        .attrs = &gi3_attrs };
    ...
    const g1  = NodeDesc{ .tag = "Card", .classes = "p-2",              .attrs = &g1_a  };
    const g2  = NodeDesc{ .tag = "Card", .classes = "p-2",              .attrs = &g2_a  };
    const g3  = NodeDesc{ .tag = "Card", .classes = "p-2",              .attrs = &g3_a  };
    const g4  = NodeDesc{ .tag = "Card", .classes = "p-2",              .attrs = &g4_a  };
    const g5  = NodeDesc{ .tag = "Card", .classes = "p-2 col-span-2",   .attrs = &g5_a  };
    const g6  = NodeDesc{ .tag = "Card", .classes = "p-2",              .attrs = &g6_a  };
    const g7  = NodeDesc{ .tag = "Card", .classes = "p-2",              .attrs = &g7_a  };
    const g8  = NodeDesc{ .tag = "Card", .classes = "p-2",              .attrs = &g8_a  };
    const g9  = NodeDesc{ .tag = "Card", .classes = "p-2",              .attrs = &g9_a  };
    const g10 = NodeDesc{ .tag = "Card", .classes = "p-2",              .attrs = &g10_a };
    const g11 = NodeDesc{ .tag = "Card", .classes = "p-2",              .attrs = &g11_a };
    const g12 = NodeDesc{ .tag = "Card", .classes = "p-2",              .attrs = &g12_a };
