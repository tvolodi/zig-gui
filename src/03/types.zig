...
//!
//! (AGENT AMENDMENT 2026-06-14: SR-03 — moved canonical impl from docs/specs/03.types.zig
//!  to src/03/types.zig per INV-5.7; src/ is now the sole compilation source.)
